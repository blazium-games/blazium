...
struct [[nodiscard]] FInt {
    static const int32_t SHIFT_AMOUNT = 12; //12 is 4096
    static const int64_t ONEL = 1 << SHIFT_AMOUNT;
	...
	constexpr FInt(int64_t interger) :
			raw_value(interger << SHIFT_AMOUNT) {}
    constexpr FInt(int64_t interger, int decimalCount) :
            raw_value(raw_value = (interger << SHIFT_AMOUNT) / decimalCount) {}
