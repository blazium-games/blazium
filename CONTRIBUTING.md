...
Report bugs [here](https://github.com/blazium-games/blazium/issues/new).
...
releases. You can find an overview of all Blazium releases [on the website](https://blazium.app/download/prebuilt-binaries)
