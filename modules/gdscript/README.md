...
For general language design guidelines, please visit the [contributing docs](https://docs.blazium.app/contributing/development/engine/gdscript_language_guidelines.html).
